...
9. Se carga el proyecto en la placa y se abre el puerto serie. Si se han puesto las credenciales de la red WiFi correctamente, debería aparecer la dirección IP del WiFi (número de 12 dígitos separado por puntos).
10. Se este número y pega en la barra de búsqueda del navegador.
11. ¡El programa ya está listo para ser usado!
